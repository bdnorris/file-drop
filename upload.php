...
//Add the allowed mime-type files to an 'allowed' array
 $allowed = array('application/pdf', 'image/gif', 'image/jpeg', 'image/png', 'image/jpg', 'video/mp4', 'video/m4v', 'video/quicktime', 'application/photoshop', 'application/illustrator', 'application/zip');
